...
data_dir = os.path.join('../data', 'movies', 'naive_bayes_true')
...
for token_dir in token_dirs:
    ...
    for eval_model_name in eval_model_names:
        ...
        eval_model_dir = os.path.join('../glue_models', 'movies', eval_model_name)
...
file = os.path.join('./movies/naive_bayes_true/eacc_stats.json')
...
file = os.path.join('./movies/naive_bayes_true/eauroc_stats.json')
with open(file, "w") as outfile:
